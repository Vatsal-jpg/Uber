...
const CaptainSignUp = () => {
  ...
  return (
      ...
      <form onSubmit={(e)=>{
        ...
        <div >
          <h3 className='text-2xl font-bold mb-3'>Captain's Name</h3>
      ...
      <p className='text-center mt-4 '>Already have an account? <Link to="/captain-login" className='text-blue-500'>Log in</Link></p>
    </div>
    <p>
